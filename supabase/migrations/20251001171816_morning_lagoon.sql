...
CREATE TABLE applications (
  ...
  resume_url text,
  portfolio_videos uuid[], -- Array of video IDs
...
-- Insert sample admin user (you'll need to register first, then update this)
-- INSERT INTO admin_users (auth_user_id, name, email, role, permissions) VALUES
-- ('your-auth-user-id', 'Admin User', 'admin@craftlab.com', 'super_admin', 
