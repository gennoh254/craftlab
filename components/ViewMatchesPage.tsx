                      ...
                      <div className="space-y-3">
                        <div className="flex items-start gap-3">
                          <div className="w-12 h-12 bg-gray-100 rounded-lg overflow-hidden shrink-0">
                            <img src={app.student?.avatar_url || `https://picsum.photos/seed/${app.student_id}/100`} className="w-full h-full object-cover" alt="Applicant" />
                          </div>
                  ...
                  {aiMatches.map((match) => (
                    <div key={match.id} className="p-4 hover:bg-gray-50/50 transition-all group">
                      <div className="space-y-3">
                        <div className="flex items-start gap-3">
                          <div className="w-12 h-12 bg-gray-100 rounded-lg overflow-hidden shrink-0">
                            <img src={match.student?.avatar_url || `https://picsum.photos/seed/${match.student_id}/100`} className="w-full h-full object-cover" alt="Match" />
                          </div>
                          <div className="space-y-1 flex-1 min-w-0">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="flex items-start gap-4 flex-1">
              <div className="w-16 h-16 bg-gray-100 rounded-xl overflow-hidden shrink-0 flex items-center justify-center">
                <img
                  src={match.opportunity?.profiles?.avatar_url || `https://picsum.photos/seed/${match.opportunity_id}/100`}
