...
import { ArrowLeft, CircleCheck as CheckCircle, Share2, Bookmark, ThumbsUp, MessageSquare, Zap, ShieldCheck, Building, Mail, MoveVertical as MoreVertical, Paperclip } from 'lucide-react';
            ...
            <div className="space-y-6">
              {post.comments.map(c => (
                <div key={c.id} className="flex gap-4">
                  <img src={c.userAvatar || `https://picsum.photos/seed/${c.userId}/60`} className="w-10 h-10 rounded-lg shrink-0" alt="User" />
